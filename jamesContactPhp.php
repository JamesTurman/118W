...
<body>
     ...
     <div class="container">
          <div class="row top-buffer-medium bottom-buffer-small transparency">
               ...
               <?php 
                    if ($_POST['callJamesPhone']!= NULL){
                         echo "Hi ".$_POST['callJamesFirstName'].", James will call you back at ".$_POST['callJamesPhone']." within 24 hours.";
                    }
                    else {
                         echo "Hi ".$_POST['emailJamesFirstName'].", we've sent you a copy of your responses to ".$_POST['emailJamesEmail']." for your records.";
                    }
                    $emailBody = "Hi ".$_POST['emailJamesFirstName'].",\n\n".
                    "James will be in touch soon! Your responses are written below for your records.\n\n".
                    "First Name: ".$_POST['emailJamesFirstName'].
                    "\nLast Name: ".$_POST['emailJamesLastName'].
                    "\nEmail: ".$_POST['emailJamesEmail'].
                    "\nProduct interested in: ".$_POST['emailJamesProduct'].
                    "\nComments: ".$_POST['emailJamesComments'].
                    "\n\nBest regards,".
                    "\nThe MeowMart Team";
                    $mail_host = "admin@meowmart.org";
                    mail($_POST['emailJamesEmail'], 'Thanks for the contact, '.$_POST['emailJamesFirstName'].'. James will be in touch soon!', $emailBody);
                    ?>
               </h2>
          </div>
    </div>
...
$date = date('Y/m/d');
$time = date('h:i:s A');
$callFirstName = $_POST['callJamesFirstName'];
$callLastName = $_POST['callJamesLastName'];
$callPhone = $_POST['callJamesPhone'];
$product = $_POST['callJamesProduct'];
$comments = $_POST['callJamesComments'];
$emailFirstName = $_POST['emailJamesFirstName'];
$emailLastName = $_POST['emailJamesLastName'];
$email = $_POST['emailJamesEmail'];
$emailProduct = $_POST['emailJamesProduct'];
$emailComments = $_POST['emailJamesComments'];
...
$Insert ="INSERT INTO Contact_James SET
          Record_ID      = '". ($Record_ID) ."',
          date            = '". ($date) ."',
          time            = '". ($time) ."',
